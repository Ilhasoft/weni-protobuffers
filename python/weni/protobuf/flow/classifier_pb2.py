...
ClassifierListRequest = _reflection.GeneratedProtocolMessageType('ClassifierListRequest', (_message.Message,), {
  ...
  '__module__' : 'flow.classifier_pb2'
