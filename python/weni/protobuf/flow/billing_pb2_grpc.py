...
from flow import billing_pb2 as flow_dot_billing__pb2
...
class BillingStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Total = channel.unary_unary(
                ...
                request_serializer=flow_dot_billing__pb2.BillingRequest.SerializeToString,
                response_deserializer=flow_dot_billing__pb2.BillingResponse.FromString,
                )
        self.Detailed = channel.unary_stream(
                '/weni.rapidpro.billing.Billing/Detailed',
                request_serializer=flow_dot_billing__pb2.BillingRequest.SerializeToString,
                response_deserializer=flow_dot_billing__pb2.ActiveContactDetail.FromString,
                )
...
def add_BillingServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Total': grpc.unary_unary_rpc_method_handler(
                    servicer.Total,
                    request_deserializer=flow_dot_billing__pb2.BillingRequest.FromString,
                    response_serializer=flow_dot_billing__pb2.BillingResponse.SerializeToString,
            ),
            'Detailed': grpc.unary_stream_rpc_method_handler(
                    servicer.Detailed,
                    request_deserializer=flow_dot_billing__pb2.BillingRequest.FromString,
                    response_serializer=flow_dot_billing__pb2.ActiveContactDetail.SerializeToString,
            ),
    }
...
class Billing(object):
    ...
    def Total(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/weni.rapidpro.billing.Billing/Total',
            flow_dot_billing__pb2.BillingRequest.SerializeToString,
            flow_dot_billing__pb2.BillingResponse.FromString,
    ...
    def Detailed(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/weni.rapidpro.billing.Billing/Detailed',
            flow_dot_billing__pb2.BillingRequest.SerializeToString,
            flow_dot_billing__pb2.ActiveContactDetail.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
