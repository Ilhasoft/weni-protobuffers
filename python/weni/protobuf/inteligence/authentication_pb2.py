...
# source: inteligence/authentication.proto
...
UserPermissionRetrieveRequest = _reflection.GeneratedProtocolMessageType('UserPermissionRetrieveRequest', (_message.Message,), {
  ...
  '__module__' : 'inteligence.authentication_pb2'
