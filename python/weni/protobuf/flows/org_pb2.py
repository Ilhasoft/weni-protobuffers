...
_ORGUPDATEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='is_active', full_name='weni.flows.org.OrgUpdateRequest.is_active', index=12,
  ...
  oneofs=[
    ...
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_is_active', full_name='weni.flows.org.OrgUpdateRequest._is_active',
...
_ORGUPDATEREQUEST.oneofs_by_name['_is_active'].fields.append(
  _ORGUPDATEREQUEST.fields_by_name['is_active'])
_ORGUPDATEREQUEST.fields_by_name['is_active'].containing_oneof = _ORGUPDATEREQUEST.oneofs_by_name['_is_active']
