...
from weni.protobuf.flows import classifier_pb2 as weni_dot_protobuf_dot_flows_dot_classifier__pb2
...
def add_ClassifierControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Create': grpc.unary_unary_rpc_method_handler(
                    servicer.Create,
                    request_deserializer=weni_dot_protobuf_dot_flows_dot_classifier__pb2.ClassifierCreateRequest.FromString,
                    response_serializer=weni_dot_protobuf_dot_flows_dot_classifier__pb2.Classifier.SerializeToString,
            ),
            'Retrieve': grpc.unary_unary_rpc_method_handler(
                    servicer.Retrieve,
                    request_deserializer=weni_dot_protobuf_dot_flows_dot_classifier__pb2.ClassifierRetrieveRequest.FromString,
                    response_serializer=weni_dot_protobuf_dot_flows_dot_classifier__pb2.Classifier.SerializeToString,
            ),
            'Destroy': grpc.unary_unary_rpc_method_handler(
                    servicer.Destroy,
                    request_deserializer=weni_dot_protobuf_dot_flows_dot_classifier__pb2.ClassifierDestroyRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'List': grpc.unary_stream_rpc_method_handler(
                    servicer.List,
                    request_deserializer=weni_dot_protobuf_dot_flows_dot_classifier__pb2.ClassifierListRequest.FromString,
                    response_serializer=weni_dot_protobuf_dot_flows_dot_classifier__pb2.Classifier.SerializeToString,
            ),
    }
